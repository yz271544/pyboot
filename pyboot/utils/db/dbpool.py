...
@file: dbpool.py
@author: lyndon
@time: Created on 2021-01-15 8:48
@env: Python
@desc:
@ref:
@blog:
...
from pyboot.utils.db.dbprop import prop
...
class DbPoolUtil(object):
    def __init__(self, config_file='config/pdbc.properties', db_type='mysql'):
        ...
        if self.__db_type == "mysql":
            ...
            self.__pool = PooledDB(db_creator, maxcached=20, maxconnections=50, maxusage=50, **config)
...
if __name__ == "__main__":
    ...
    sql3 = """SELECT * FROM t_custm_grp_bas_info"""
